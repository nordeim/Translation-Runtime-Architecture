"""Generate severity heatmap PNG for Round 7 audit.

Output: /home/z/my-project/Translation-Runtime-Architecture/docs/audit/round7/TRA_audit_severity_heatmap_r7.png
"""
...
# Font setup for CJK + Latin (per Rule 7)
...
def main() -> None:
    ...
    ax.set_title(
        f"TRA Round 7 Audit — Severity by Track (Issues Only)\n"
    ...
    track_scopes = {
        "A7": "Spec conformance",
        "B7": "Code quality & security",
        "C7": "Doc-vs-code consistency",
        "D7": "Test suite",
        "E7": "Forensic L4 e2e",
        "F7": "Stub-module conformance",
    }
