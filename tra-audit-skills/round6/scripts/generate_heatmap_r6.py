"""Generate severity heatmap PNG for Round 6 audit.

Output: /home/z/my-project/Translation-Runtime-Architecture/docs/audit/round6/TRA_audit_severity_heatmap_r6.png
"""
...
def main() -> None:
    ...
    ax.set_title(
        f"TRA Round 6 Audit — Severity by Track (Issues Only)\n"
    ...
    track_scopes = {
        "A6": "Spec conformance",
        "B6": "Code quality & security",
        "C6": "Doc-vs-code consistency",
        "D6": "Test suite",
        "E6": "Forensic L4 e2e",
        "F6": "Stub-module conformance",
    }
