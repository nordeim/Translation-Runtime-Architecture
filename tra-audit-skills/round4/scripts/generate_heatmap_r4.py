"""Generate severity heatmap PNG for Round 4 audit.

Output: /home/z/my-project/download/TRA_Round4/TRA_audit_severity_heatmap_r4.png
"""
...
def main() -> None:
    ...
    ax.set_title(
        f"TRA Round 4 Audit — Severity by Track (Issues Only)\n"
    ...
    track_scopes = {
        "A4": "Spec conformance",
        "B4": "Code quality & security",
        "C4": "Doc-vs-code consistency",
        "D4": "Test suite",
        "E4": "Forensic L4 e2e",
        "F4": "Stub-module conformance",
    }
